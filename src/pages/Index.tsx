...
export default function Index() {
  const { nodes, edges, onNodesChange, onEdgesChange, onConnect, addNode, selectNode, selectEdge, importJSON, selectedNodeId, selectedEdgeId } = useDesignStore(useShallow((state) => ({
    nodes: state.nodes,
    edges: state.edges,
