...
export default function NodeConfigPanel({ mobile = false }: NodeConfigPanelProps) {
  const { nodes, edges, selectedNodeId, selectedEdgeId, selectNode, selectEdge, updateNodeConfig, updateEdgeConfig, deleteSelected, duplicateNode } = useDesignStore(useShallow((state) => ({
    nodes: state.nodes, edges: state.edges, selectedNodeId: state.selectedNodeId,
    selectedEdgeId: state.selectedEdgeId, selectNode: state.selectNode, selectEdge: state.selectEdge,
    updateNodeConfig: state.updateNodeConfig, updateEdgeConfig: state.updateEdgeConfig,
    deleteSelected: state.deleteSelected, duplicateNode: state.duplicateNode,
  })));
