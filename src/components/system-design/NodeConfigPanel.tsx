...
const getNodeLabel = (data: unknown) =>
  (data as SystemNodeData | undefined)?.label ?? "Unknown";
...
export default function NodeConfigPanel({
  ...
  const {
    ...
    useShallow((s) => ({
      ...
      updateEdgeConfig: s.updateEdgeConfig,
        ...
        <div className="p-3 space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <Input
              ...
              value={d.latency ?? 5}
              onChange={(e) =>
                updateEdgeConfig(selectedEdge.id, { latency: +e.target.value })
              }
            />
          </div>
          <div className="space-y-1.5">
        ...
        <div className="p-3 space-y-4">
          <div className="space-y-1.5">
            ...
            <Input
              ...
              value={d.label}
              onChange={(e) =>
                updateNodeConfig(selectedNodeId!, { label: e.target.value })
              }
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <div className="space-y-1.5">
              ...
              <Select
                value={d.region}
                onValueChange={(v) =>
                  updateNodeConfig(selectedNodeId!, { region: v })
                }
              >
                <SelectTrigger className="h-8 text-xs">
                  <SelectValue />
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="space-y-1.5">
              ...
              <Input
                ...
                value={d.cpu}
                onChange={(e) =>
                  updateNodeConfig(selectedNodeId!, { cpu: +e.target.value })
                }
              />
            </div>
            <div className="space-y-1.5">
              ...
              <Input
                ...
                value={d.memory}
                onChange={(e) =>
                  updateNodeConfig(selectedNodeId!, { memory: +e.target.value })
                }
              />
            </div>
          </div>
          ...
          <div className="space-y-1.5">
            <div className="flex items-center justify-between">
              ...
              <Badge variant="outline" className="text-[10px] h-5 font-mono">
                {d.throughputLimit} req/s
              </Badge>
            </div>
            <Slider
              value={[d.throughputLimit]}
              min={10}
              max={10000}
              step={10}
              onValueChange={([v]) =>
                updateNodeConfig(selectedNodeId!, { throughputLimit: v })
              }
            />
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <Input
              ...
              value={d.latency}
              onChange={(e) =>
                updateNodeConfig(selectedNodeId!, { latency: +e.target.value })
              }
            />
          </div>
            ...
            <>
              ...
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  min={1}
                  className="h-8 text-xs"
                  value={d.maxQueueDepth ?? 10000}
                  onChange={(e) =>
                    updateNodeConfig(selectedNodeId!, {
                      maxQueueDepth: +e.target.value,
                    })
                  }
                />
              </div>
                  ...
                  <div className="space-y-1">
                    ...
                    {incomingEdges.map((e) => {
                      ...
                      return (
                        <div
                          key={e.id}
                          className="flex items-center gap-1.5 text-[10px] text-muted-foreground bg-accent/50 rounded px-2 py-1"
                        >
                          <span className="font-medium text-foreground">
                            {getNodeLabel(sourceNode?.data)}
                          </span>
                          <span>via</span>
                          <ProtocolBadge
                            protocol={ed.protocol || "HTTP"}
                            compact
                          />
                        </div>
                      );
          ...
          <div className="space-y-1.5">
            ...
            <Textarea
              ...
              value={d.notes}
              onChange={(e) =>
                updateNodeConfig(selectedNodeId!, { notes: e.target.value })
              }
            />
          </div>
        </div>
