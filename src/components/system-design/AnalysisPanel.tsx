...
export default function AnalysisPanel() {
  const { warnings, nodes, edges, simulationRunning, simulationMode, simulationStep, simulationMaxSteps, simulationFailedNodeIds, simulationScenario } = useDesignStore(
    useShallow((state) => ({
