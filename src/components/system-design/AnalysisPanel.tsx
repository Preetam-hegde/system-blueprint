...
export default function AnalysisPanel() {
  const { warnings, nodes, edges, simulation } = useDesignStore(useShallow((state) => ({ warnings: state.warnings, nodes: state.nodes, edges: state.edges, simulation: state.simulation })));
