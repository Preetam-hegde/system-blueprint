...
export default function Toolbar() {
  ...
  } = useDesignStore(useShallow((state) => ({ undo: state.undo, redo: state.redo, exportJSON: state.exportJSON, importJSON: state.importJSON, clearCanvas: state.clearCanvas, nodes: state.nodes, edges: state.edges, autoLayout: state.autoLayout })));
